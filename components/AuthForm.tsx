...
const AuthForm = ({ type }: { type: string }) => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (type === 'sign-in') {
        const response = await signIn({ // Use the correct function name
          email: data.email,
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              {type === 'sign-up' && (
                <>
                  ...
                  <div className='flex gap-4'>
                    <CustomInput control={form.control} name='state' label='State' placeholder='Example: HYD' />
                    <CustomInput control={form.control} name='postalCode' label='Postal Code' placeholder='Example: 509321' />
                  </div>
                  <div className='flex gap-4'>
      ...
      <>
       ...
       <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        {type === 'sign-up' && (
          ...
          <div className='flex gap-4'>
          <CustomInput control={form.control} name='state' label='State' placeholder='Example:HYD'/>
          <CustomInput control={form.control} name='postalCode' label='Postal Code' placeholder='Example:500001'/>
          </div>
          <div className='flex gap-4'>
          <CustomInput control={form.control} name='dateOfBirth' label='Date Of Birth' placeholder='YYYY-MM-DD'/>
          <CustomInput control={form.control} name='SSN' label='SSN' placeholder='Example:1234'/>
